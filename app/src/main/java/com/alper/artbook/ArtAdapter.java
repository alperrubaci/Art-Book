...
import com.alper.artbook.databinding.RecyclerRowBinding;
...
public class ArtAdapter extends RecyclerView.Adapter<ArtAdapter.ArtHolder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull final ArtAdapter.ArtHolder holder, final int position) {
    ...
    public class ArtHolder extends RecyclerView.ViewHolder{
        ...
        public ArtHolder(RecyclerRowBinding binding) {
            super(binding.getRoot());//gorunumu alabiliyoruz
